...
letters_sequence_max_length = 1
numbers_sequence_max_length = 150
sequence_max_length = letters_sequence_max_length * 4 + numbers_sequence_max_length * 5

def generate_custom_sentence(pos_or_neg: str = "pos"):
    def rand_digits():
        return ''.join(random.choices('123456789', k=random.randint(1, numbers_sequence_max_length)))

    def rand_letters(letter):
        return letter * random.randint(1, letters_sequence_max_length)
