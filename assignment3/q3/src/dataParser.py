...
class CharDataParser:
    ...
    @staticmethod
    def parse(train_path, dev_path=None):  # dev_path is optional now
        train_data = CharDataParser._load_file(train_path)

        # Load dev data only if dev_path provided
